...
```text
e:\WORKSPACE_NODEJS_V.1.0.0\crewlink_client_ng>gulp clear:project <br />
e:\WORKSPACE_NODEJS_V.1.0.0\crewlink_client_ng> gulp build <br />
e:\WORKSPACE_NODEJS_V.1.0.0\crewlink_client_ng> gulp <br />
```
